<template>
  <div class="order" v-if="items" v-cloak>
    <mt-loadmore 
      :bottom-method="loadBottom" 
      :bottom-all-loaded="allLoaded" 
      @bottom-status-change="handleBottomChange"
    ref="loadmore">
      <div class="order-list" v-for="(item, index) in items.lists" :key="index">
...
<script>
import {orderLists, orderConfirm, orderCancel} from '@/data/getData';
export default {
  data () {
    return {
      items: {
